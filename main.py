...
PLAYERS = ["SiwyDzik1","Zardion","Foecee","xXx_ZibeX_PL_xXx","Aserocik","xxXx_Reaper_xXxx","gosiaa_95","Czajurka","iamwojteak","Szaki_71","BOBER_POS","Stiven01_","Dariusz_-_","ACEMUNDPL","AvangardoPoland","BabciazZusu","fedek1","DarekCSW","Hangman1990","Hangman90","hogis320","karolr92","karpiu223","kejku","Konrad_Ak47","LowcaBobrow","lucek-23","Mannia1991","Misiaczek89","Radeusz","Rodriguez_Lopez","SEBIX777","SIWYDYM91_","StaryKefir","SuperLosiek","Witruoz","Zablakany69"]
...
HEADERS = {
    "Authorization": "Bearer " + str(PUBG_API_KEY),
...
# =========================
# 🔎 SZUKANIE GRACZA (WSZYSTKIE PLATFORMY)
# =========================
...
async def check_matches():
    ...
    for player in PLAYERS:
        try:
            ...
            matches = p["relationships"]["matches"]["data"][:3]
